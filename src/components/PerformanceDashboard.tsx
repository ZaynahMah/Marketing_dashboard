...
import { AiOpportunities, AiPlanner } from "./ai/AiSections";
      ...
      {active === "Competitors" && (
        <section>
          <SectionTitle
            ...
            hint="Live competitor tracking (Myntra, AJIO, Nykaa and more) runs in the Social Listener workspace."
          />
          <Card className="flex flex-wrap items-center justify-between gap-4 p-6">
            <p className="max-w-md text-[13px] leading-relaxed text-graphite">
              Open the Social Listener pulse to compare share of voice, content cadence and audience reaction against
              the competitive set in real time.
            </p>
            <a
              href={COMPETITOR_URL}
              target="_blank"
