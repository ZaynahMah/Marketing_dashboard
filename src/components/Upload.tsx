  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      <div className="fade-in">
        <Eyebrow>Consolidate · Merge · Report</Eyebrow>
        <h1 className="display mt-3 text-[34px] font-medium leading-[1.1] text-ink md:text-[42px]">
          Two exports in.
          <br />
          <span className="italic text-claret">One source of truth</span> out.
        </h1>
        <p className="mt-4 max-w-xl text-[14px] leading-relaxed text-slate">
          Drop the Meta Business Suite organic export and the paid campaign export. The workspace matches every
          post by its Instagram link, merges organic and paid into one consolidated dataset, and builds the
          executive audit, performance dashboard and Tata CLiQ Luxury strategy — no manual stitching.
        </p>
      </div>
