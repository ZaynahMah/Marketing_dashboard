  ...
  return (
    <div>
      <SectionTitle
        ...
        hint="Ten flagship recurring formats plus twenty trend-anchored one-offs. Every recommendation names brands from the TCL catalog with a per-brand rationale, drafts a ready-to-publish caption in the @tatacliqluxury voice, and ties to a live cultural signal. Refreshed once per calendar day."
      />
