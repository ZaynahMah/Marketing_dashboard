...
export function ExecutiveAudit({ posts, label }: { posts: ConsolidatedPost[]; label: string }) {
  ...
  return (
    <div className="fade-in">
      ...
      {/* AI strategy controls (deterministic dashboard works with or without a key) */}
      <div className="mt-6">
        <AiControls />
      </div>
      ...
      <div className="mt-12">
        ...
        />
        <AiStrategicRecommendations posts={posts} />
      </div>

      {/* Emerging opportunities + budget guidance (AI-only; hidden without a key) */}
      <div className="mt-12">
        <AiEmergingOpportunities />
        <AiBudgetAllocation />
      </div>
