...
export async function callGemini(
  ...
  const body = {
    ...
    tools: [{ google_search: {} }],
    // Quality over speed: allow the model room for deep, multi-section reasoning.
    generationConfig: { temperature: 1.05, topP: 0.95, maxOutputTokens: 8192 },
  };
  ...
  return {
    ...
    strategist: parsed.strategist && typeof parsed.strategist === "object" ? parsed.strategist : undefined,
